...
\begin{titlepage}
    ...
    \vspace{0.8cm}
    {\large Technology Stack: Next.js, Docker, Jenkins, Ansible, Kubernetes, Vault, SonarQube, Trivy\par}
    \vfill
    \begin{tabular}{rl}
...
automation, Vault-backed Kubernetes secrets for API key handling, and Kubernetes
manifests for scalable production deployment.
...
\begin{itemize}[leftmargin=*]
    ...
    \item Deploy the application to a local Kubernetes cluster using Minikube.
...
health checks, metrics, and autoscaling configuration.
